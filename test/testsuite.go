...
type UnitTestSuite struct {
	...
	FakeActivationCodeClient   *fake.FakeActivationCodeClient
...
func (s *UnitTestSuite) SetupDefaultApplication() {
	...
	s.FakeActivationCodeClient = fake.NewFakeActivationCodeClient(s.T(), configuration.Namespace())
...
func (s *UnitTestSuite) ActivationCodes() kubeclient.ActivationCodeInterface {
	return s.FakeActivationCodeClient
}
